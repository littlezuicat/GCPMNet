...
class GCPMNet(nn.Module):
    ...
    def forward(self, x, kernel):
        ...
        res1 = self.Encoder[0](x_, kernel)
        # 128
        z = self.feat_extract[1](res1)
        z = self.FAM2(z, z2)
        res2 = self.Encoder[1](z, kernel)
        # 64
        z = self.feat_extract[2](res2)
        z = self.FAM1(z, z4)
        z = self.Encoder[2](z, kernel)

        z = self.Decoder[0](z, kernel)
